...
nyc_precincts <- read_sf("~/Documents/2020/nypd_allegations/data/Police Precincts/geo_export_cfbe857e-58ec-4848-b99b-1f33fd967621.shp")

#Alleged misconduct from ProPublica
allegations <- read_csv("~/Documents/2020/nypd_allegations/data/allegations_20200726939.csv")
